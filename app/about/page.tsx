    ...
    <div style={{ background: 'linear-gradient(135deg, #102A1C 0%, #295936 100%)', minHeight: '100vh', overflow: 'hidden', position: 'relative' }}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, padding: '8rem 1rem 6rem 1rem', maxWidth: '900px' }}>
        <div style={{ marginBottom: '2.5rem', display: 'flex', justifyContent: 'flex-start' }}>
          <button 
            onClick={() => router.push('/')} 
            style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', padding: '10px 24px', borderRadius: '30px', color: 'white', fontWeight: 800, cursor: 'pointer', transition: 'all 0.2s', fontSize: '1rem', display: 'inline-flex', alignItems: 'center', gap: '8px', backdropFilter: 'blur(10px)' }}
          ...
          >
            <span style={{ fontSize: '1.2rem', lineHeight: 1 }}>←</span> Back to Home
          </button>
        </div>
        <motion.div 
        ...
        >
          <span style={{ display: 'inline-block', padding: '0.5rem 1.5rem', backgroundColor: 'var(--color-tertiary)', color: 'white', borderRadius: '30px', fontWeight: 'bold', marginBottom: '1.5rem', border: '1px solid rgba(255,255,255,0.2)' }}>
            Our Story
          </span>
          <h1 style={{ fontSize: '4.5rem', fontWeight: 800, color: 'white', letterSpacing: '-1.5px', marginBottom: '1.5rem', lineHeight: 1.1 }}>
            Rooted in{' '}
          ...
          <p style={{ fontSize: '1.25rem', color: 'rgba(255,255,255,0.85)', lineHeight: 1.8, maxWidth: '700px', margin: '0 auto' }}>
        ...
        >
          ...
          <h2 style={{ fontSize: '2.5rem', color: 'var(--color-primary-dark)', marginBottom: '1.5rem', fontWeight: 700 }}>Our Mission</h2>
          ...
          <div style={{ marginTop: '4rem', paddingTop: '3rem', borderTop: '2px dashed rgba(75, 174, 79, 0.2)', textAlign: 'center' }}>
            <p style={{ fontSize: '2rem', fontWeight: 700, fontStyle: 'italic', color: 'var(--color-tertiary)', lineHeight: 1.4 }}>
